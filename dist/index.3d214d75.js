...
const showRecipe = async function() {
    try {
        ...
        if (!id) return;
        //Show spinner tell the recipe loads
        renderSpinner(recipeContainer);
        //3.assign the recipe to a variable
        const res = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}?key=${`9cd21288-902f-4306-a141-5a2290a3851b`}`);
        ...
        //4.Store the markup of the recipe
        const markup = `
    ...
    <div class="recipe__ingredients">
      ...
      ${recipe.ingredients.map((ing)=>{
        ...
        <div class="recipe__description">
          <span class="recipe__unit"> ${ing.unit === null ? "yes" : ing.unit} </span> ${ing.description}
        </div>
      </li>`;
        }).join(" ")}
    ...
    <div class="recipe__directions">
      ...
      <div class="recipe__direction-box">
        ...
        <p class="recipe__directions-text">
          ...
          <span class="recipe__publisher">${recipe.publisher}</span>. You
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime":"dXNgZ","regenerator-runtime/runtime":"dXNgZ"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}]},["3smKr","bB7Pu"], "bB7Pu", "parcelRequired50c")
